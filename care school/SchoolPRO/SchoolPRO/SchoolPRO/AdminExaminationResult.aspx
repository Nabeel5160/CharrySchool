<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminExaminationResult.aspx.cs" Inherits="SchoolPRO.AdminExaminationResult" %>
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main no-padding">
                                                ...
                                                <div class=" hidden-print col-lg-3">
                                                    ...
                                                    <asp:SqlDataSource runat="server" ID="ddlexam" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT nExam_id, strExamName, bisDeleted, nsch_id FROM tbl_ExamType WHERE (nsch_id = @schid) AND (bisDeleted = @bit)">
                                                        <SelectParameters>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-xs-2">
                                                                            <div class="pull-right"> <asp:Image ImageUrl="" Height="150" Width="110" ID="imgstdnt" runat="server" /> </div>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- /.col -->
																...
																<span class="red">
                                                                    ...
                                                                    <div class="well">
                                                                        <div class="align-center">
                                                                            Powered By LENOX Technologies , CHERRY School Solution | www.lenox.com
                                                                     0319-97062989 | 0333-9957111
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
