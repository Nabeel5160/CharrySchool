<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminManageEmployeeSalary.aspx.cs" Inherits="SchoolPRO.AdminManageEmployeeSalary" %>
                                ...
                                <div class="no-border">
                                    ...
                                    <form id="freg">
                                                <fieldset>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <asp:DropDownList ID="ddenm" CssClass="form-control" AutoPostBack="true" runat="server" DataSourceID="empDS" OnSelectedIndexChanged="ddenm_SelectedIndexChanged" DataTextField="name" DataValueField="nu_id" AppendDataBoundItems="true"><asp:ListItem>--Select Employee--</asp:ListItem></asp:DropDownList>
                                                            ...
                                                            <asp:SqlDataSource runat="server" ID="empDS" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT [nu_id], [strfname]+' '+[strlname] as name FROM [tbl_Users] WHERE (([bisDeleted] = @bisDeleted) AND ([nLevel] =@am_emp OR [nLevel] = @adm_emp OR [nLevel] = @lib_emp OR [nLevel] = @hstl_emp )  and nsch_id=@schid)">
                                                                <SelectParameters>
                                                                    <asp:Parameter DefaultValue="false" Name="bisDeleted" Type="Boolean"></asp:Parameter>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            Present: <asp:Label ID="lblp" runat="server" Text="0"></asp:Label>&nbsp;
                        Abscent: <asp:Label ID="lbla" runat="server" Text="0"></asp:Label>&nbsp;
                        Late: <asp:Label ID="lbllate" runat="server" Text="0"></asp:Label>&nbsp;
                       Half Leave: <asp:Label ID="lblhalflv" runat="server" Text="0"></asp:Label>
                                                            &nbsp;
                       Full Leave: <asp:Label ID="lblfullv" runat="server" Text="0"></asp:Label>
                                                        </span>
                                                    </label>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
