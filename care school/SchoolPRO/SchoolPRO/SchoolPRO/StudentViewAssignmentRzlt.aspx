<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="StudentViewAssignmentRzlt.aspx.cs" Inherits="SchoolPRO.StudentViewAssignmentRzlt" %>
                ...
                <SelectParameters>
                    ...
                    <asp:View ID="View2" runat="server">
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource ID="sqlmarks" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolPro %>" SelectCommand="SELECT ex.nr_id,e.strStudentNum, e.strFname, e.strLname,ex.strTotalMarks, ex.strObtMarks, ex.strRemarks FROM tbl_Enrollment AS e INNER JOIN tbl_Result AS ex ON e.ne_id = ex.ne_id WHERE e.bisDeleted='False' and  e.ne_id=@eid and ex.strType='Assignment' and ex.nsch_id=@schid">
                                <SelectParameters>
