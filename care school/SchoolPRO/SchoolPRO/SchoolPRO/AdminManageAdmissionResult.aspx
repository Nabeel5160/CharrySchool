<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminManageAdmissionResult.aspx.cs" Inherits="SchoolPRO.AdminManageAdmissionResult" %>
                        ...
                        <asp:MultiView ID="mvstlist" ActiveViewIndex="0" runat="server">
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main no-padding">
                                                ...
                                                <div class=" hidden-print col-lg-3">
                                                    ...
                                                    <asp:SqlDataSource runat="server" ID="ddlexam" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT nExam_id, strExamName, bisDeleted, nsch_id FROM tbl_Admission WHERE  (bisDeleted = @bit)">
                                                        <SelectParameters>
                                                ...
                                                <asp:GridView ID="gv_detail_list" AutoGenerateColumns="false" CssClass=" table table-striped table-bordered table-hover" runat="server">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Reg No" DataField="Roll_Number" />
                                                        <asp:BoundField HeaderText="Name" DataField="Name" />
                                                        <asp:BoundField HeaderText="Class" DataField="Class" />
                                                        <asp:BoundField HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" HeaderText="Section" DataField="Section" />
                            ...
                            <asp:View ID="View1" runat="server">
                                ...
                                <div class="page-content-area">
                                    <div class="row">
                                        <div id="printable1" class="col-xs-12">
                                            <!-- PAGE CONTENT BEGINS -->
                                                        ...
                                                        <div class="widget-body">
                                                            <div class="widget-main padding-24">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="row">
                                                                            <ul class="list-unstyled spaced">
                                                                                ...
                                                                                <%--<li>
                                                                                    <i class="ace-icon fa fa-caret-right blue"></i>
                                                                                    Section&nbsp;  :<asp:Label runat="server" ID="txtstSec"></asp:Label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-11 label label-lg label-info arrowed-in arrowed-right">
                                                                        <b>
                                                                            <asp:Label runat="server" ID="txtterm" Text="Term"></asp:Label></b>
                                                                    </div>
                                                                </div>
                                                                <div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-5 pull-right">
                                                                            <h4 class="pull-right">Obt/Total :
																<span class="red">
                                                                    <td>
                                                                        <asp:Label runat="server" ID="txttotobtmarks"></asp:Label>
                                                                </span>
                                                                                <span>/</span>
                                                                                <span class="red">
                                                                                    <td>
                                                                                        <asp:Label runat="server" ID="txttotAllsubmarks"></asp:Label>
                                                                                </span>
                                                                            </h4>
                                                                        </div>
                                                                        <div class="col-sm-5 pull-right">
                                                                            <h4 class="pull-right">Status :
																<span class="red">
                                                                    <td>
                                                                        <asp:Label runat="server" ID="txtPercentage"></asp:Label>
                                                                </span>
                                                                            </h4>
                                                                        </div>
                                                                    ...
                                                                    <div class="well">
                                                                        <div class="align-center">
                                                                            Powered By Teachsoul , Farmecole School Management Sys | www.farmecole.com |
                                                                    0321-9883140 | 051-33.....
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <!-- /.col -->
                                            <label class="hidden-print width-30 pull-right btn btn-sm btn-success" onclick="printDiv('printable1')">Print</label>
                                        </div>
                                        <!-- /.row -->
                                    </div>
                                    <!-- /.page-content-area -->
