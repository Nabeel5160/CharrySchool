...
namespace SchoolPRO
{
    public partial class StudentChangePassword : System.Web.UI.Page
    {
        ...
        protected void btnChange_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Select strPassword from tbl_Enrollment where ne_id='" + Session["eid"] + "' and bisDeleted='False'";
            ...
            if (oldflag)
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Update   tbl_Enrollment set strPassword='" + txtpwd.Text + "' where nu_id='" + Session["eid"] + "' and bisDeleted='False'";
