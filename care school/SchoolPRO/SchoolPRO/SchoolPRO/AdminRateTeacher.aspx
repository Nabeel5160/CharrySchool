<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminRateTeacher.aspx.cs" Inherits="SchoolPRO.AdminRateTeacher" %>
                ...
                <ContentTemplate>
                    <asp:MultiView ID="mvquiz" ActiveViewIndex="0" runat="server">
                        <asp:View ID="View1" runat="server">
                            <asp:Button ID="btngotoAdd" runat="server" Text="Add" OnClick="btngotoAdd_Click" class="width-10 pull-left btn btn-sm btn-success"/>
                            <div class="table-responsive">
                                <asp:GridView ID="gvrteachrate" class="table table-striped table-bordered table-hover" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="nTRate_id" DataSourceID="DSTeachViewrate">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" DataField="nTRate_id" HeaderText="nTRate_id" ReadOnly="True" InsertVisible="False" SortExpression="nTRate_id"></asp:BoundField>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="btndel" runat="server" Text="Delete" OnClick="btndel_Click" class="width-85 pull-left btn btn-sm btn-success"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                        
                                </asp:GridView>
                                <asp:SqlDataSource runat="server" ID="DSTeachViewrate" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT tbl_TeacherRating.nTRate_id, tbl_Users.strfname + ' ' + tbl_Users.strlname AS 'Teacher Name', tbl_TeacherRating.strRemarks AS 'Remarks', tbl_TeacherRating.strPoints AS 'Points', tbl_TeacherRating.strOutOf AS 'Out Of' FROM tbl_TeacherRating INNER JOIN tbl_Users ON tbl_TeacherRating.nTeach_id = tbl_Users.nu_id WHERE (tbl_TeacherRating.bisDeleted = @fbit) AND (tbl_Users.bisDeleted = @fbit) AND (tbl_TeacherRating.nsch_id=@schid)">
                                    <SelectParameters>
                                                       ...
                                                       <%-- <label class="block clearfix">
                                                        ...
                                                        <label class="block clearfix">
                                                            <span class="block input-icon input-icon-right">
                                                                ...
                                                                <asp:SqlDataSource runat="server" ID="DSTeacher" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT nu_id, strfname + ' ' + strlname AS name FROM tbl_Users WHERE (nLevel = 2) AND (bisDeleted = @fbit) AND (nsch_id=@schid)">
                                                                    <SelectParameters>
                                                                        <asp:Parameter DefaultValue="False" Name="fbit"></asp:Parameter>
                                                                        <asp:SessionParameter SessionField="nschoolid" Name="schid" />
                                                                    </SelectParameters>
                                                                    ...
                                                                    <asp:UpdatePanel ID="pnlRating" runat="server">
                                                                        <ContentTemplate>
                                                                            <table>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Rating ID="RatingControl" AutoPostBack="true" OnChanged="RatingControl_Changed" StarCssClass="ratingEmpty" WaitingStarCssClass="ratingSaved" EmptyStarCssClass="ratingEmpty" FilledStarCssClass="ratingFilled" runat="server"></asp:Rating>
