<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminManageDesignation.aspx.cs" Inherits="SchoolPRO.AdminManageDesignation" %>
                            ...
                            <asp:View ID="View1" runat="server">
                               ...
                               <div class="space-30"></div>
                                 <div id="printable" class="table-responsive">
                                    ...
                                    <asp:GridView ID="gvDesig" EmptyDataText="NO DATA FOUND" class="table table-striped table-bordered table-hover" runat="server" OnPageIndexChanging="gvDesig_PageIndexChanging" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" ShowHeader="true" OnRowCommand="gvDesig_RowCommand" OnRowUpdating="gvDesig_RowUpdating" DataKeyNames="nDesg_id" EnableViewState="true">
                                        <Columns>
                                            <asp:TemplateField >
                                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" DataField="nDesg_id" HeaderText="S.NO" SortExpression="nc_id" />
                                            ...
                                            <asp:TemplateField HeaderText="Designation">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblcname" runat="server" Text='<%# Eval("strDesgName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="strDesgCode" SortExpression="strDesgCode" HeaderText="Code" />
                                            <asp:TemplateField HeaderStyle-CssClass="hidden-print" ItemStyle-CssClass="hidden-print" >
                                                <ItemTemplate>
                                                ...
                                                <div class="widget-main">
                                                    ...
                                                    <form id="Form2">
                                                        <fieldset>
                                                            ...
                                                            <label class="block clearfix">
                                                                <span class="block input-icon input-icon-right">
                                                                    <asp:TextBox ID="txtaddDesig" class="form-control" placeholder="Designation Name" runat="server"></asp:TextBox>
                                                                    <i class="icon-user"></i>
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Designation Name" ControlToValidate="txtaddDesig"></asp:RequiredFieldValidator>
                                                                </span>
                                                            </label>
                                                            <label class="block clearfix">
                                                                <span class="block input-icon input-icon-right">
                                                                    <asp:TextBox ID="txtDesigCode" class="form-control" placeholder="Designation Code" runat="server"></asp:TextBox>
                                                                    <i class="icon-user"></i>
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Designation Code" ControlToValidate="txtDesigCode"></asp:RequiredFieldValidator>
                                                                </span>
                                                            </label>
                                                            <div class="space-24"></div>

                                                            <div class="clearfix">
                                                                <asp:Button ID="btnaddclass" runat="server" Text="Add Designation" class="width-65 pull-right btn btn-sm btn-success" OnClick="btnaddclass_Click" />
                                                            </div>
                                                        </fieldset>
                                                    </form>
                                                </div>
