...
namespace SchoolPRO
{
    public partial class AdminExaminationResult : System.Web.UI.Page
    {
                    ...
                    foreach (GridViewRow gvr in gv_detail_list.Rows)
                    {
                        ...
                        if (status == "Pass")
                        {
                            ...
                            if (InsertFlag)
                            {
                                ...
                                new_class = ddclass1.SelectedItem.Text;
                                new_sec = ddsec1.SelectedItem.Text;
                                con.Open();
                                cmd.Connection = con;
                                cmd.CommandType = CommandType.Text;
                                ...
                                string Newstnum = GenrerateStudentNumber(ddclass1.Text, ddsec1.Text);
        ...
        string GenrerateStudentNumber(string classid, string secid)
        {
            ...
            else
            {
                ...
                string stnum = new_class + new_sec + "-" + "1";
                con.Close();
                return stnum;
                //txtstnum.Text = stnum;
            }
