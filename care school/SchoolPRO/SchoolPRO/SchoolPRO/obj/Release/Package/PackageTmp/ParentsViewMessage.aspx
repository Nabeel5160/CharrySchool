<%@ Page Title="" Language="C#" MasterPageFile="~/Parent.Master" AutoEventWireup="true" CodeBehind="ParentsViewMessage.aspx.cs" Inherits="SchoolPRO.ParentsViewMessage" %>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                <ul class="list-unstyled spaced">
                                                     ...
                                                     <li><%labname.Text = Session["pname"].ToString(); %>
