<%@ Page Title="" Language="C#" MasterPageFile="~/Parent.Master" AutoEventWireup="true" CodeBehind="ParentViewResult.aspx.cs" Inherits="SchoolPRO.ParentViewResult" %>
    ...
    <div class="col-xs-12">
								...
								<div class="row-fluid">
									<ul class="ace-thumbnails">
                                        ...
                                        <li>
											<a href="ParentView_First_Rzlt.aspx" data-rel="colorbox">
                                        ...
                                        <li>
											<a href="ParentView_Second_Rzlt.aspx" data-rel="colorbox">
												<img alt="150x150" src="assets/images/gallery/muser.jpg" />
												<div class="tags">
													<span class="label-holder">
                                        ...
                                        <li>
											<a href="ParentViewExamRzlt.aspx" data-rel="colorbox">
												<img alt="150x150" src="assets/images/gallery/muser.jpg" />
												<div class="tags">
													<span class="label-holder">
                                        ...
                                        <li>
											<a href="ParentViewQuizRzlt.aspx" data-rel="colorbox">
                                        ...
                                        <li>
											<a href="ParentViewAssignmentRzlt.aspx" data-rel="colorbox">
