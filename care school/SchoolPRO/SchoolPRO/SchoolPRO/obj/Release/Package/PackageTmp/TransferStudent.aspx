<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="TransferStudent.aspx.cs" Inherits="SchoolPRO.TransferStudent" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="pull-right">
                            <asp:Button CssClass="hidden-print btn btn-success" ID="btnPromote" Text="Click Here To Change Section" runat="server" OnClick="btnPromote_Click" />
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
