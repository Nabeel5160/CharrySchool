...
namespace SchoolPRO
{
    public partial class ParentsViewRating : System.Web.UI.Page
    {
        ...
        protected void btndel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "update tbl_ParantRateTeacher set bisDeleted=@tbit,dtDeleteDate=@date where nPRateT_id=@did";
