<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="StudentProfile.aspx.cs" Inherits="SchoolPRO.StudentProfile" %>
                ...
                <ContentTemplate>
                    <asp:MultiView ActiveViewIndex="0" ID="mvsub" runat="server">
                          <asp:View ID="View3" runat="server">
                              <div id="Div1" class="user-profile row">
                                ...
                                <%
                                    ...
                                    string query = "select strImage,strFname,strMname,strDOB,strPhAddress,strCity,strState,strCountry,nPinCode,strPhone,strEmail from tbl_Enrollment where ne_id='" + Session["eid"] + "' ";
                                    cmd.Connection = con;
                                    con.Open();
                                ...
                                <div class="row-fluid">
                                    <div>
                                        <div id="user-profile-1" class="user-profile row">
                                            ...
                                            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Student Not Found.');", true);
                                                        }
                                                %>
