...
namespace SchoolPRO
{
    public partial class ParentsViewMessage : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("ParentsReplyToTeacherMessage.aspx");
        }
        ...
        //        con.Open();
        //        cmd.CommandType = CommandType.Text;
        //        cmd.CommandText = "select strfname+' '+strlname  as name from tbl_Users where nu_id='" + Session["senderid1"] + "'";
        //        dr = cmd.ExecuteReader();
        //        while (dr.Read())
        //        {
