<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher.Master" AutoEventWireup="true" CodeBehind="TeacherViewMessage.aspx.cs" Inherits="SchoolPRO.TeacherViewMessage" %>
                                ...
                                using (con2)
                                {
                                    ...
                                    if (dr.HasRows)
                                    {
                                        ...
                                        while (dr.Read())
                                        {
                                            ...
                                            string a = Session["senderid1"].ToString();
                                            tempList.Add(c);
                                        }
                                        tempList.TrimExcess();
                                        con2.Close();
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                <ul class="list-unstyled spaced">
                                                     ...
                                                     <li><%labname.Text = Session["usname"].ToString(); %>
