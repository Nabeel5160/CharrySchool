<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminViewDeflauterStudents.aspx.cs" Inherits="SchoolPRO.AdminViewDeflauterStudents" %>
                            ...
                            <div id="printable">
                                ...
                                <div class="widget-header header-color-blue">
                                    <h5 class="bigger lighter">
                                        ...
                                        Students With UnPaid Fee And With Their Dues
                                    </h5>
                                ...
                                <div class="space-6"></div>
                                <div class="table-responsive">
                                    <asp:GridView OnRowDataBound="gvsearchclass_RowDataBound" OnDataBound="gvsearchclass_DataBound" ID="gvsearchclass" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Exists" ShowFooter="true" ShowHeader="true" class="table table-striped table-bordered table-hover" runat="server" AllowSorting="True" OnSorting="gvsearchclass_Sorting" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="strMonths" SortExpression="strMonths" HeaderText="Month" />
                                            <asp:BoundField DataField="strFeeMonth" SortExpression="strFeeMonth" HeaderText="Fee Month" />
