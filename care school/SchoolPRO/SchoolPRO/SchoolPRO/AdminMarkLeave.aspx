<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminMarkLeave.aspx.cs" Inherits="SchoolPRO.AdminMarkLeave" %>
                    ...
                    <asp:MultiView ID="mvquiz" ActiveViewIndex="0" runat="server">
                        <asp:View runat="server" ID="v0">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="gvadmin" EmptyDataText="No Data Found" class="table table-striped table-bordered table-hover" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="nLeav_id" DataSourceID="DSAdminConformtechleav">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
