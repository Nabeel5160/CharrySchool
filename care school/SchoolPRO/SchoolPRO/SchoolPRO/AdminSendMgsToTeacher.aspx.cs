...
namespace SchoolPRO
{
    public partial class AdminSend_MgsTo_Teacher : System.Web.UI.Page
    {
        ...
        protected void btnview_Click(object sender, EventArgs e)
        {
            ...
            Session["techid"] = gvr.Cells[1].Text;
        ...
        protected void btnaddMessage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@mgssend", Session["techid"].ToString());
