<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminManageNewAdmission.aspx.cs" Inherits="SchoolPRO.AdminManageNewAdmission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <h6 >You Can Add New Admission Student With Their Parent Details for More Help Please Contact Administration</h6>
    </div>
    <div class="col-xs-12">
                            ...
                            <div class="col-lg-offset-3 col col-lg-6" style="background: #f2f2f2;">
                                ...
                                <asp:UpdatePanel runat="server">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="text-center">Student Admission Date :</label>
                                            <label class=" clearfix">

                                                <asp:TextBox ID="txtadmsndate" class="form-control" placeholder="Admission Date" runat="server" MaxLength="10" onkeyup="return ismaxlength(this,10)"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            <label class="text-center">Student Date of Birth :</label>

                                            <label class=" clearfix">

                                                <asp:TextBox ID="txtdob" class="form-control" placeholder="Date of Birth" runat="server" onkeyup="return ismaxlength1(this,10)" MaxLength="10"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            <div class="block input-icon input-icon-right">
                                                ...
                                                <%--<asp:SqlDataSource ID="sqlclass" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolPro %>" SelectCommand="SELECT [strClass],[nc_id] FROM [tbl_Class] where bisDeleted=0 and nsch_id=@schid">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="schid" SessionField="nschoolid" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>--%>

                                                <asp:DropDownList AutoPostBack="true"  Width="250px" ID="ddsec" runat="server" CssClass="input-medium" DataTextField="strSection" DataValueField="nsc_id" OnSelectedIndexChanged="ddsec_SelectedIndexChanged" AppendDataBoundItems="False">
                                        ...
                                        <div class="form-group">
                                            <div class="block input-icon input-icon-right">
                                                <asp:TextBox ID="txtstnum" ReadOnly="true" Visible="false" class="form-control" placeholder="Student Roll Num" runat="server" OnTextChanged="txtstnum_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="block input-icon input-icon-right">
                                                ...
                                                <asp:TextBox ID="txtnic" class="form-control" MaxLength="13" AutoPostBack="true" placeholder="Father NIC" OnTextChanged="txtnic_TextChanged" runat="server"></asp:TextBox>
                                                <%--<asp:RegularExpressionValidator CssClass="red" runat="server" ID="ZipCodeValidator" ControlToValidate="txtnic" ErrorMessage="Range must be in 13 Character long!" ValidationExpression="(\d{13})?" />--%>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValisdsdassstosdr4" CssClass="red" ErrorMessage="Enter Guardian CNIC if any (0-9)" ControlToValidate="txtgardnic" ValidationExpression="^\d*$" runat="server" />

                                            </div>
                                            <div class="form-group">
                                                <asp:TextBox ID="txtgardname" class="form-control" placeholder="Guardian Name" runat="server"></asp:TextBox>
                                                <asp:RegularExpressionValidator ID="RegularExpressionssdValidator4" CssClass="red" ErrorMessage="Enter Guardian Name if any" ControlToValidate="txtgardname" ValidationExpression="^[a-zA-Z''-'\s]*$" runat="server" />
                                            ...
                                            <%--<label class=" clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <asp:DropDownList ID="ddcl" runat="server" CssClass="input-medium" AutoPostBack="true" DataSourceID="sqlclass" DataTextField="strClass" DataValueField="strClass"></asp:DropDownList>
                                               <asp:SqlDataSource ID="sqlclass" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolPro %>" SelectCommand="SELECT [strClass] FROM [tbl_Class] where bisDeleted=0"></asp:SqlDataSource>

                                            </span>
                                        </label>
                                        <label class=" clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <asp:DropDownList ID="ddsec" runat="server" CssClass="input-medium" DataSourceID="sqlsec" DataTextField="strSection" DataValueField="strSection"></asp:DropDownList>
                                                <asp:SqlDataSource ID="sqlsec" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolPro %>" SelectCommand="SELECT [strSection] FROM [tbl_Section] where nc_id=(select nc_id from tbl_Class where strClass=@cid and bisDeleted=0)and bisDeleted=0">
                                                    <SelectParameters>
                                                        <asp:ControlParameter ControlID="ddcl" Name="cid" Type="String" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
                                        ...
                                        <label class=" clearfix">
                                            ...
                                            <label class=" clearfix">
                                                <span class="block input-icon input-icon-right">
                                                    <label class="text-center">Guardian Email :</label>
                                                    <asp:TextBox ID="txtem" TextMode="Email" class="form-control" placeholder="Guardian Email" runat="server"></asp:TextBox>
                                            ...
                                            <label class=" clearfix">
                                                <span class="block input-icon input-icon-right">
                                                    ...
                                                    <asp:TextBox ID="txtpwd" TextMode="Password" class="form-control" placeholder="Guardian Password" runat="server"></asp:TextBox>
                                            ...
                                            <label class=" clearfix">
                                                <span class="block input-icon input-icon-right">
                                                    ...
                                                    <asp:TextBox ID="txtsemail" TextMode="Email" Text="" class="form-control" placeholder="Student Email" runat="server"></asp:TextBox>
