<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminConfirmAttendance.aspx.cs" Inherits="SchoolPRO.AdminConfirmAttendance" %>
                ...
                <ContentTemplate>
                    <asp:MultiView ID="mvatnd" ActiveViewIndex="0" runat="server">
                        <asp:View ID="View1" runat="server">
                            ...
                            <asp:Label Text="From :" runat="server" CssClass="label"></asp:Label>
                            ...
                            <asp:Label ID="Label1" CssClass="label" Text="To :" runat="server"></asp:Label>
                        ...
                        <asp:View ID="View2" runat="server">
                                                ...
                                                <form id="freg">
                                                    <fieldset>
                                                        ...
                                                        <div class="clearfix">
                                                            ...
                                                            <asp:Button ID="btngoback" runat="server" Text="Go Back" class="width-65 pull-right btn btn-sm btn-success" OnClick="btngoback_Click" />
                            ...
                            <asp:SqlDataSource ID="sqltch" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolPro %>" SelectCommand="SELECT [strfname]+' '+[strlname] as name,nu_id FROM [tbl_Users] WHERE ([nLevel] = @u_level) AND  nsch_id=@schid and bisDeleted='False'">
                                <SelectParameters>
                                                ...
                                                <form id="Form1">
                                                    <fieldset>
                                                        ...
                                                        <div class="clearfix">
                                                            ...
                                                            <asp:Button ID="btnbck" runat="server" Text="Go Back" class="width-65 pull-right btn btn-sm btn-success" OnClick="btnbck_Click"  />
                                                        </div>
                                                    </fieldset>
                                                </form>
                                                -
