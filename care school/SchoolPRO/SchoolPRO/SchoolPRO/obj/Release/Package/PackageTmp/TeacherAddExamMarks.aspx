<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher.Master" AutoEventWireup="true" CodeBehind="TeacherAddExamMarks.aspx.cs" Inherits="SchoolPRO.TeacherAddExamMarks" %>
                ...
                <asp:MultiView ID="mvmarks" ActiveViewIndex="0" runat="server">
                    ...
                    <asp:View ID="View2" runat="server">
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource runat="server" ID="examtypDS" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT nExam_id, strExamName, bisDeleted, nsch_id FROM tbl_ExamType WHERE (bisDeleted = @bit) AND (nsch_id = @schid)">
                                <SelectParameters>
