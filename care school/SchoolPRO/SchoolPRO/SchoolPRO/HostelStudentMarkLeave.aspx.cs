...
namespace SchoolPRO
{
    public partial class HostelStudentMarkLeave : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (string add in res)
                    {
                        ...
                        cmd.CommandType = CommandType.Text;
                        cmd.Parameters.Clear();
                        cmd.CommandText = "insert into tbl_Leave(nLevel,bAccept,bCancel,Date,strReason,nsch_id,nu_id,dtAddDate,bisDeleted,bPanding) values (4,@tbit,@fbit,@dat,@rea,@sch,@userid,@dformat,@fbit,@fbit)";
