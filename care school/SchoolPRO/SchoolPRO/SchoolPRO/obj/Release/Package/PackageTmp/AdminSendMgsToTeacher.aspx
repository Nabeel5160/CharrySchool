<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminSendMgsToTeacher.aspx.cs" Inherits="SchoolPRO.AdminSend_MgsTo_Teacher" %>
                ...
                <asp:MultiView ID="mvt" ActiveViewIndex="0" runat="server">
                    <asp:View ID="View1" runat="server">
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource runat="server" ID="sqladmn" ConnectionString='<%$ ConnectionStrings:SchoolPro %>' SelectCommand="SELECT nu_id, strfname + ' ' + strlname AS Name, strEducation AS Education, strAddress AS Address FROM tbl_Users WHERE (bisDeleted = @fbit) AND (nsch_id=@schid) AND (nLevel = 2)">
                                <SelectParameters>
